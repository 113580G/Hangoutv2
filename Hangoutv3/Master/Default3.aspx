<%@ Page Title="" Language="C#" MasterPageFile="~/Master/upselldownsell.master" AutoEventWireup="true" CodeFile="Default3.aspx.cs" Inherits="Master_Default3" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<div id="content">
<div id="upselltop">WAIT! WE HAVE A SPECIAL DEAL JUST FOR YOU TODAY!</div>
<div id="topoffer">
<div id="topoffercontent">
<ul id="offerlist">
<li><img src="Images/buttons/tick_big_1.png" /><asp:Label ID="Label2" 
        runat="server" Text="Label2 :Photography Service"></asp:Label>
    </li>
<li><img src="Images/buttons/tick_big_1.png" /><asp:Label ID="Label3" 
        runat="server" Text="Label3: Customize T-Shirt"></asp:Label>
    </li>
<li><img src="Images/buttons/tick_big_1.png" />&nbsp; 5 Additonal Services:<br />
    <ul id="as">
        <li>
            <asp:Label ID="Label6" runat="server" Text="Label5: Additional Service 1"></asp:Label>
        </li>
        <li>
            <asp:Label ID="Label7" runat="server" Text="Label6: Additional Service 2"></asp:Label>
        </li>
        <li>
            <asp:Label ID="Label8" runat="server" Text="Label7: Additional Service 3"></asp:Label>
        </li>
        <li>
            <asp:Label ID="Label9" runat="server" Text="Label8: Additional Service 4"></asp:Label>
        </li>
        <li>
            <asp:Label ID="Label10" runat="server" Text="Label9: Additional Service 5"></asp:Label>
        </li>
        </ul>
    </li>
</ul>
...
For limited time only, 
    ...
    <asp:Label ID="Label5" runat="server" Text="insertUpsellPrice"></asp:Label>
    /person
    <a href="payment.aspx">
    <br /><img alt="addtocartbutton" class="style1" 
        src="Images/buttons/addtocartbutton2.jpg" border="none" /></a>
    <p />
<span class="rejected"><a href="downsell.aspx">No thanks, i don't want this fabulous offer and i know this will never be offered again. Proceed me to checkout now.</a></span>
...
For limited time only, 
    ...
    <asp:Label ID="Label1" runat="server" Text="insertUpsellPrice"></asp:Label>
    /person
    <br />
    <a href="payment.apsx">
    <img alt="addtocartbutton" class="style1" 
        src="Images/buttons/addtocartbutton2.jpg" border="none" /></a>
        <br /><a href="downsell.aspx"><span class="rejected">No thanks, i don't want this fabulous offer and i know this will never be offered again. Proceed me to checkout now.</span></a>
        <a href="upsell.apsx"><br /><img alt="cardpayment" 
        class="style2" src="Images/buttons/credit.jpg" border="none"/></a>
